...
class BurgerBuilder extends Component {
    ...
    /**
     * When ingredients are added, enables order functionality
     * @param ingredients
     */
    ...
    /**
     * Adds the selected ingredient and refreshes the price
     * @param type
     */
    ...
    /**
     * Removes the selected ingredient and refreshes the price
     * @param type
     */
    ...
    /**
     * Allows the order overlay to be displayed
     */
    purchaseHandler = () => {
    ...
    /**
     * Submits the order (with dummy data)
     */
            ...
            burger = (
                <Auxiliary>
                    ...
                    <BuildControls ingredientAdded={this.addIngredientHandler}
                                   ingredientRemoved={this.removeIngredientHandler} disabled={disableInfo}
